...
gdjs.Untitled_32sceneCode.asyncCallback21222892 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Untitled_32sceneCode.asyncCallback21222892(runtimeScene, asyncObjectsList)));
}
}
...
{gdjs.evtTools.sound.playSound(runtimeScene, "Complete_02.aac", false, 100, gdjs.randomFloatInRange(0.8, 1));
